...
(function(global) {
	...
	global['$sys']['lib'] = {
		'babel-standalone': [
				'libraries/babel-standalone-7.10.2.min',
				'/beta/emuos/assets/js/libraries/babel-standalone-7.10.2.min',
				'//emupedia.net/beta/emuos/assets/js/libraries/babel-standalone-7.10.2.min',
				'//emupedia.org/beta/emuos/assets/js/libraries/babel-standalone-7.10.2.min',
				'//emuos.net/beta/emuos/assets/js/libraries/babel-standalone-7.10.2.min',
				'//emuos.org/beta/emuos/assets/js/libraries/babel-standalone-7.10.2.min'
		],
		'bootstrap': [
		...
		'dropbox': [
				...
				'/beta/emuos/assets/js/libraries/dropbox-4.0.30.min',
				'//emupedia.net/beta/emuos/assets/js/libraries/dropbox-4.0.30.min',
				'//emupedia.org/beta/emuos/assets/js/libraries/dropbox-4.0.30.min',
				'//emuos.net/beta/emuos/assets/js/libraries/dropbox-4.0.30.min',
				'//emuos.org/beta/emuos/assets/js/libraries/dropbox-4.0.30.min'
		],
		'dropbox-team': [
				'libraries/dropbox-team-4.0.30.min',
				'/beta/emuos/assets/js/libraries/dropbox-team-4.0.30.min',
				'//emupedia.net/beta/emuos/assets/js/libraries/dropbox-team-4.0.30.min',
				'//emupedia.org/beta/emuos/assets/js/libraries/dropbox-team-4.0.30.min',
				'//emuos.net/beta/emuos/assets/js/libraries/dropbox-team-4.0.30.min',
				'//emuos.org/beta/emuos/assets/js/libraries/dropbox-team-4.0.30.min'
		],
		'emularity': [
				'libraries/emularity',
		...
		'i18next': [
				...
				'/beta/emuos/assets/js/libraries/i18next-19.4.5.min',
				'//emupedia.net/beta/emuos/assets/js/libraries/i18next-19.4.5.min',
				'//emupedia.org/beta/emuos/assets/js/libraries/i18next-19.4.5.min',
				'//emuos.net/beta/emuos/assets/js/libraries/i18next-19.4.5.min',
				'//emuos.org/beta/emuos/assets/js/libraries/i18next-19.4.5.min'
		],
		'jquery': [
				'libraries/jquery-3.5.0.min',
				'/beta/emuos/assets/js/libraries/jquery-3.5.0.min',
				'//emupedia.net/beta/emuos/assets/js/libraries/jquery-3.5.0.min',
				'//emupedia.org/beta/emuos/assets/js/libraries/jquery-3.5.0.min',
				'//emuos.net/beta/emuos/assets/js/libraries/jquery-3.5.0.min',
				'//emuos.org/beta/emuos/assets/js/libraries/jquery-3.5.0.min'
		],
		'jquery-1.x': [
				'libraries/jquery-1.12.4.min',
				'/beta/emuos/assets/js/libraries/jquery-1.12.4.min',
				'//emupedia.net/beta/emuos/assets/js/libraries/jquery-1.12.4.min',
				'//emupedia.org/beta/emuos/assets/js/libraries/jquery-1.12.4.min',
				'//emuos.net/beta/emuos/assets/js/libraries/jquery-1.12.4.min',
				'//emuos.org/beta/emuos/assets/js/libraries/jquery-1.12.4.min'
		],
		'jquery-2.x': [
				'libraries/jquery-2.2.4.min',
				'/beta/emuos/assets/js/libraries/jquery-2.2.4.min',
				'//emupedia.net/beta/emuos/assets/js/libraries/jquery-2.2.4.min',
				'//emupedia.org/beta/emuos/assets/js/libraries/jquery-2.2.4.min',
				'//emuos.net/beta/emuos/assets/js/libraries/jquery-2.2.4.min',
				'//emuos.org/beta/emuos/assets/js/libraries/jquery-2.2.4.min'
		],
		'jquery-3.x': [
				'libraries/jquery-3.5.0.min',
				'/beta/emuos/assets/js/libraries/jquery-3.5.0.min',
		...
		'jquery-ui-1.11.x': [
				...
				'/beta/emuos/assets/js/libraries/jquery-ui-1.11.4.min',
				'//emupedia.net/beta/emuos/assets/js/libraries/jquery-ui-1.11.4.min',
				'//emupedia.org/beta/emuos/assets/js/libraries/jquery-ui-1.11.4.min',
				'//emuos.net/beta/emuos/assets/js/libraries/jquery-ui-1.11.4.min',
				'//emuos.org/beta/emuos/assets/js/libraries/jquery-ui-1.11.4.min'
		],
		'jquery-ui-1.12.x': [
				'libraries/jquery-ui-1.12.1.min',
				'/beta/emuos/assets/js/libraries/jquery-ui-1.12.1.min',
		...
		'jsrsasign-all': [
				'libraries/jsrsasign-all-8.0.16.min',
				'/beta/emuos/assets/js/libraries/jsrsasign-all-8.0.16.min',
				'//emupedia.net/beta/emuos/assets/js/libraries/jsrsasign-all-8.0.16.min',
				'//emupedia.org/beta/emuos/assets/js/libraries/jsrsasign-all-8.0.16.min',
				'//emuos.net/beta/emuos/assets/js/libraries/jsrsasign-all-8.0.16.min',
				'//emuos.org/beta/emuos/assets/js/libraries/jsrsasign-all-8.0.16.min'
		],
		'jszip': [
				'libraries/jszip-3.4.0.min',
				'/beta/emuos/assets/js/libraries/jszip-3.4.0.min',
				'//emupedia.net/beta/emuos/assets/js/libraries/jszip-3.4.0.min',
				'//emupedia.org/beta/emuos/assets/js/libraries/jszip-3.4.0.min',
				'//emuos.net/beta/emuos/assets/js/libraries/jszip-3.4.0.min',
				'//emuos.org/beta/emuos/assets/js/libraries/jszip-3.4.0.min'
		],
		'less': [
		...
		'moment': [
				...
				'/beta/emuos/assets/js/libraries/moment-2.26.0.min',
				'//emupedia.net/beta/emuos/assets/js/libraries/moment-2.26.0.min',
				'//emupedia.org/beta/emuos/assets/js/libraries/moment-2.26.0.min',
				'//emuos.net/beta/emuos/assets/js/libraries/moment-2.26.0.min',
				'//emuos.org/beta/emuos/assets/js/libraries/moment-2.26.0.min'
		],
		'moment-holiday': [
		...
		'polyfill-es6-custom-elements': [
				...
				'/beta/emuos/assets/js/libraries/polyfill-es6-custom-elements-1.4.1.min',
				'//emupedia.net/beta/emuos/assets/js/libraries/polyfill-es6-custom-elements-1.4.1.min',
				'//emupedia.org/beta/emuos/assets/js/libraries/polyfill-es6-custom-elements-1.4.1.min',
				'//emuos.net/beta/emuos/assets/js/libraries/polyfill-es6-custom-elements-1.4.1.min',
				'//emuos.org/beta/emuos/assets/js/libraries/polyfill-es6-custom-elements-1.4.1.min'
		],
		'polyfill-es6-custom-event': [
				'libraries/polyfill-es6-custom-event-1.0.7',
				'/beta/emuos/assets/js/libraries/polyfill-es6-custom-event-1.0.7',
				'//emupedia.net/beta/emuos/assets/js/libraries/polyfill-es6-custom-event-1.0.7',
				'//emupedia.org/beta/emuos/assets/js/libraries/polyfill-es6-custom-event-1.0.7',
				'//emuos.net/beta/emuos/assets/js/libraries/polyfill-es6-custom-event-1.0.7',
				'//emuos.org/beta/emuos/assets/js/libraries/polyfill-es6-custom-event-1.0.7'
		],
		'polyfill-es6-fetch': [
				'libraries/polyfill-es6-fetch-3.0.0',
				'/beta/emuos/assets/js/libraries/polyfill-es6-fetch-3.0.0',
				'//emupedia.net/beta/emuos/assets/js/libraries/polyfill-es6-fetch-3.0.0',
				'//emupedia.org/beta/emuos/assets/js/libraries/polyfill-es6-fetch-3.0.0',
				'//emuos.net/beta/emuos/assets/js/libraries/polyfill-es6-fetch-3.0.0',
				'//emuos.org/beta/emuos/assets/js/libraries/polyfill-es6-fetch-3.0.0'
		],
		'polyfill-es6-html-imports': [
				'libraries/polyfill-es6-html-imports-1.2.4.min',
				'/beta/emuos/assets/js/libraries/polyfill-es6-html-imports-1.2.4.min',
				'//emupedia.net/beta/emuos/assets/js/libraries/polyfill-es6-html-imports-1.2.4.min',
				'//emupedia.org/beta/emuos/assets/js/libraries/polyfill-es6-html-imports-1.2.4.min',
				'//emuos.net/beta/emuos/assets/js/libraries/polyfill-es6-html-imports-1.2.4.min',
				'//emuos.org/beta/emuos/assets/js/libraries/polyfill-es6-html-imports-1.2.4.min'
		],
		'polyfill-es6-promise': [
				'libraries/polyfill-es6-promise-4.2.8.min',
				'/beta/emuos/assets/js/libraries/polyfill-es6-promise-4.2.8.min',
				'//emupedia.net/beta/emuos/assets/js/libraries/polyfill-es6-promise-4.2.8.min',
				'//emupedia.org/beta/emuos/assets/js/libraries/polyfill-es6-promise-4.2.8.min',
				'//emuos.net/beta/emuos/assets/js/libraries/polyfill-es6-promise-4.2.8.min',
				'//emuos.org/beta/emuos/assets/js/libraries/polyfill-es6-promise-4.2.8.min'
		],
		'polyfill-es6-web-components': [
				'libraries/polyfill-es6-web-components-2.4.3.min',
				'/beta/emuos/assets/js/libraries/polyfill-es6-web-components-2.4.3.min',
				'//emupedia.net/beta/emuos/assets/js/libraries/polyfill-es6-web-components-2.4.3.min',
				'//emupedia.org/beta/emuos/assets/js/libraries/polyfill-es6-web-components-2.4.3.min',
				'//emuos.net/beta/emuos/assets/js/libraries/polyfill-es6-web-components-2.4.3.min',
				'//emuos.org/beta/emuos/assets/js/libraries/polyfill-es6-web-components-2.4.3.min'
		],
		'polyfill-es7-babel-polyfill': [
				'libraries/polyfill-es7-babel-polyfill-7.10.1.min',
				'/beta/emuos/assets/js/libraries/polyfill-es7-babel-polyfill-7.10.1.min',
				'//emupedia.net/beta/emuos/assets/js/libraries/polyfill-es7-babel-polyfill-7.10.1.min',
				'//emupedia.org/beta/emuos/assets/js/libraries/polyfill-es7-babel-polyfill-7.10.1.min',
				'//emuos.net/beta/emuos/assets/js/libraries/polyfill-es7-babel-polyfill-7.10.1.min',
				'//emuos.org/beta/emuos/assets/js/libraries/polyfill-es7-babel-polyfill-7.10.1.min'
		],
		'popper': [
		...
		'xterm': [
				...
				'/beta/emuos/assets/js/libraries/xterm-4.6.0.min',
				'//emupedia.net/beta/emuos/assets/js/libraries/xterm-4.6.0.min',
				'//emupedia.org/beta/emuos/assets/js/libraries/xterm-4.6.0.min',
				'//emuos.net/beta/emuos/assets/js/libraries/xterm-4.6.0.min',
				'//emuos.org/beta/emuos/assets/js/libraries/xterm-4.6.0.min'
		],
		'desktop': [
				'desktop',
