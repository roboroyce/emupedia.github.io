...
utils = {
	...
	eval: function(a, b) {
		for (var c = '', d = 0; d < b.length; d++) {
			c += 'string' === typeof b[d] ? '\'' + b[d] + '\'' : b[d].toString(), d < b.length - 1 && (c += ',');
		}
		return a + '(' + c + ');';
	},
	clone: function(a) {
	...
	extend: function(a, b) {
		for (var c in b) {
			void 0 === a[c] ? null !== b[c] && void 0 !== b[c] && 'object' === typeof b[c] ? (a[c] = 'number' === typeof b[c].length ? [] : {}, utils.extend(a[c], b[c])) : a[c] = b[c] : 'object' === typeof b[c] && utils.extend(a[c], b[c]);
		}
	},
	overwrite: function(a, b) {
		for (var c in b) {
			null !== b[c] && void 0 !== b[c] && 'object' === typeof b[c] ? (a[c] = 'number' === typeof b[c].length ? [] : {}, utils.overwrite(a[c], b[c])) : a[c] = b[c];
		}
	},
...
resources = {
	...
	init: function(a, b) {
		...
		resources.count = 0;
		for (var d in resources.textures) {
			'string' === typeof resources.textures[d] && resources.count++;
		}
		for (var e in resources.images) {
			'string' === typeof resources.images[e] && resources.count++;
		}
		for (d in resources.textures) {
			'string' === typeof resources.textures[d] && (resources[d] ? (resources.count--, !resources.count && a && a()) : (c = new Image, c.id = d, c.onload = function() {
				...
				for (var d = 0; d < b; d++) {
					resources[this.id][d] = [];
					for (var e = 0; e < c; e++) {
						resources[this.id][d][e] = new resources.Texture(this, d, e);
					}
				}
				resources.count--;
				!resources.count && a && a();
		...
		for (e in resources.images) {
			'string' === typeof resources.images[e] && (resources[e] ? (resources.count--, !resources.count && a && a()) : (c = new Image, c.id = e, c.onload = function() {
...
resources.palette = [
	[0, 0, 0], [0, 0, 168], [0, 168, 0], [0, 168, 168], [168, 0, 0], [168, 0, 168], [168, 84, 0], [192, 192, 192], [84, 84, 84], [84, 84, 252], [84, 252, 84], [84, 252, 252], [252, 84, 84], [252, 84, 252], [252, 252, 84], [252, 252, 252], [236, 236, 236], [220, 220, 220], [208, 208, 208], [192, 192, 192], [180, 180, 180], [168, 168, 168], [152, 152, 152], [140, 140, 140], [124, 124, 124], [112, 112, 112], [100, 100, 100], [84, 84, 84], [72, 72, 72], [56, 56, 56], [44, 44, 44], [32, 32, 32], [252, 0, 0], [236, 0, 0], [224, 0, 0], [212, 0, 0], [200, 0, 0], [188, 0, 0], [176, 0, 0], [164, 0, 0], [
		152, 0,
		0
	], [136, 0, 0], [124, 0, 0], [112, 0, 0], [100, 0, 0], [88, 0, 0], [76, 0, 0], [64, 0, 0], [252, 216, 216], [252, 184, 184], [252, 156, 156], [252, 124, 124], [252, 92, 92], [252, 64, 64], [252, 32, 32], [252, 0, 0], [252, 168, 92], [252, 152, 64], [252, 136, 32], [252, 120, 0], [228, 108, 0], [204, 96, 0], [180, 84, 0], [156, 76, 0], [252, 252, 216], [252, 252, 184], [252, 252, 156], [252, 252, 124], [252, 248, 92], [252, 244, 64], [252, 244, 32], [252, 244, 0], [228, 216, 0], [204, 196, 0], [180, 172, 0], [156, 156, 0], [132, 132, 0], [112, 108, 0], [88, 84, 0], [64, 64, 0], [208, 252, 92], [196, 252, 64], [
		180, 252,
		32
	], [160, 252, 0], [144, 228, 0], [128, 204, 0], [116, 180, 0], [96, 156, 0], [216, 252, 216], [188, 252, 184], [156, 252, 156], [128, 252, 124], [96, 252, 92], [64, 252, 64], [32, 252, 32], [0, 252, 0], [0, 252, 0], [0, 236, 0], [0, 224, 0], [0, 212, 0], [4, 200, 0], [4, 188, 0], [4, 176, 0], [4, 164, 0], [4, 152, 0], [4, 136, 0], [4, 124, 0], [4, 112, 0], [4, 100, 0], [4, 88, 0], [4, 76, 0], [4, 64, 0], [216, 252, 252], [184, 252, 252], [156, 252, 252], [124, 252, 248], [92, 252, 252], [64, 252, 252], [32, 252, 252], [0, 252, 252], [0, 228, 228], [0, 204, 204], [0, 180, 180], [0, 156, 156], [0, 132, 132], [0, 112, 112],
	[0, 88, 88], [0, 64, 64], [92, 188, 252], [64, 176, 252], [32, 168, 252], [0, 156, 252], [0, 140, 228], [0, 124, 204], [0, 108, 180], [0, 92, 156], [216, 216, 252], [184, 188, 252], [156, 156, 252], [124, 128, 252], [92, 96, 252], [64, 64, 252], [32, 36, 252], [0, 4, 252], [0, 0, 252], [0, 0, 236], [0, 0, 224], [0, 0, 212], [0, 0, 200], [0, 0, 188], [0, 0, 176], [0, 0, 164], [0, 0, 152], [0, 0, 136], [0, 0, 124], [0, 0, 112], [0, 0, 100], [0, 0, 88], [0, 0, 76], [0, 0, 64], [40, 40, 40], [252, 224, 52], [252, 212, 36], [252, 204, 24], [252, 192, 8], [252, 180, 0], [180, 32, 252], [168, 0, 252], [152, 0, 228], [128, 0, 204], [
		116,
		0, 180
	], [96, 0, 156], [80, 0, 132], [68, 0, 112], [52, 0, 88], [40, 0, 64], [252, 216, 252], [252, 184, 252], [252, 156, 252], [252, 124, 252], [252, 92, 252], [252, 64, 252], [252, 32, 252], [252, 0, 252], [224, 0, 228], [200, 0, 204], [180, 0, 180], [156, 0, 156], [132, 0, 132], [108, 0, 112], [88, 0, 88], [64, 0, 64], [252, 232, 220], [252, 224, 208], [252, 216, 196], [252, 212, 188], [252, 204, 176], [252, 196, 164], [252, 188, 156], [252, 184, 144], [252, 176, 128], [252, 164, 112], [252, 156, 96], [240, 148, 92], [232, 140, 88], [220, 136, 84], [208, 128, 80], [200, 124, 76], [188, 120, 72], [180, 112, 68],
	[168, 104, 64], [160, 100, 60], [156, 96, 56], [144, 92, 52], [136, 88, 48], [128, 80, 44], [116, 76, 40], [108, 72, 36], [92, 64, 32], [84, 60, 28], [72, 56, 24], [64, 48, 24], [56, 44, 20], [40, 32, 12], [96, 0, 100], [0, 100, 100], [0, 96, 96], [0, 0, 28], [0, 0, 44], [48, 36, 16], [72, 0, 72], [80, 0, 80], [0, 0, 52], [28, 28, 28], [76, 76, 76], [92, 92, 92], [64, 64, 64], [48, 48, 48], [52, 52, 52], [216, 244, 244], [184, 232, 232], [156, 220, 220], [116, 200, 200], [72, 192, 192], [32, 180, 180], [32, 176, 176], [0, 164, 164], [0, 152, 152], [0, 140, 140], [0, 132, 132], [0, 124, 124], [0, 120, 120], [0, 116, 116], [
		0,
		112, 112
	], [0, 108, 108], [152, 0, 136]
];
audio = {
	...
	sounds: {
		...
		hitdoor: 'sounds/knifehitdoor',
		donothing: 'sounds/sfx/donothing',
		atkknife: 'sounds/atkknife',
		...
		ahhhg: 'sounds/ahhhg',
		gutentag: 'sounds/gutentag', // sounds/sfx/default1
		mutti: 'sounds/mutti',
		kein: 'sounds/kein', // sounds/sfx/default1
		mein: 'sounds/mein', // sounds/sfx/default2
		schabbsha: 'sounds/schabbsha', // sounds/sfx/default1
		meingott: 'sounds/meingott', // sounds/sfx/default2
		hitlerha: 'sounds/hitlerha',
		tothund: 'sounds/tothund',
		die: 'sounds/die', // sounds/sfx/default1
		mechstep: 'sounds/mechstep',
		scheist: 'sounds/scheist',
		eva: 'sounds/eva',
		eine: 'sounds/eine', // sounds/sfx/default1
		donner: 'sounds/donner', // sounds/sfx/default1
		erlauben: 'sounds/erlauben', // sounds/sfx/default1
		rose: 'sounds/rose', // sounds/sfx/default2
	...
	request: function(a, b, c) {
		if (audio.context) {
			...
			audio.buffers[a] = new Audio(b + (audio.canPlayMP4 ? '.mp4' : '.ogg')), audio.buffers[a].preload = !0, c && c();
		}
	},
	init: function(a) {
	...
	playSound: function(a,
		...
		if (audio.canPlay && 0 !== audio.soundsVolume) {
			if (audio.context) {
				...
				if ((c ? e : 1) && f) {
					if (c) {
						e.src.noteOff(0), e.gain = audio.context.createGainNode(), e.src = audio.context.createBufferSource(), e.src.buffer = f, e.src.connect(e.gain), e.gain.connect(audio.context.destination), e.gain.gain.value = (null === b || void 0 === b ? 1 : b) * audio.soundsVolume, e.src.noteOn(0);
					} else {
					...
					audio.request(a, audio.sounds[a], function() {
				...
				audio.request(a, audio.sounds[a],
					function() {
...
sprites = {
	Sprite: function(a) {
		...
		this.listeners = {};
		if (a.listeners) {
			for (var b in a.listeners) {
				this.listeners[b] = utils.bind(this,
					a.listeners[b]);
			}
		}
	}
...
secret.SecretWall.prototype = {
	...
	move: function() {
		...
		if (a || null === a) {
			this.map.removeSecret(this), this.process = null, secret.process.splice(secret.process.indexOf(this), 1);
		}
	},
	push: function() {
...
maps = {
	...
	Map: function(a, b) {
		...
		this.treasures = 0;
		if (a.sprites) {
			for (c = 0; c < a.sprites.length; c++) {
				d = a.sprites[c], 29 <= d.texture && 32 >= d.texture && this.treasures++, d.type ? d.level <= (b || 1) && this.ai.push(new d.type(d)) : (d.resource = a.spriteResource, this.sprites.push(new sprites.Sprite(d)));
			}
		}
		this.secrets = [];
		this.secretsHistory = {remove: []};
		if (a.secrets) {
			for (c = 0; c < a.secrets.length; c++) {
				d = a.secrets[c], d.map = this, this.map[d.x][d.y] = d.texture + 1,
...
maps.Map.prototype = {
	generateHitMap: function() {
		...
		for (var a = 0; a < this.map.length; a++) {
			...
			for (var b = 0; b < this.map[a].length; b++) {
				if (this.spriteMap[a][b] = [], 0 < this.map[a][b]) {
					this.hit[a][b] = 1;
		...
		for (d = 0; d < this.secrets.length; d++) {
			e =
	...
	getGraph: function() {
		for (var a = [], b = 0; b < this.hit.length; b++) {
			a[b] = [];
			for (var c = 0; c < this.hit[b].length; c++) {
				a[b][c] = this.hit[b][c];
			}
		}
		for (b = 0; b < this.sprites.length; b++) {
			c = this.sprites[b], c.hitpoints && (a[c.baseX][c.baseY] = 1);
		}
		return new Graph(a);
	},
	...
	inDoor: function(a, b) {
		for (var c = -this.hitDistance; c <= this.hitDistance; c++) {
			for (var d = -this.hitDistance; d <= this.hitDistance; d++) {
				if (this.getDoor(floor(a + c / 10), floor(b + d / 10))) {
					return !1;
				}
			}
		}
	...
	getSecret: function(a, b, c) {
		...
		if (!d) {
			if (e) {
				return e.process && 0 === e.direction.x && (c = this.getMapValue(a, b), a = this.getSecret(a, b, e), !c && !a) ? (e.hidden = !0, e) : null;
			}
			if (f) {
				return f.process && 0 === f.direction.x && (c = this.getMapValue(a, b), a = this.getSecret(a, b, f), !c && !a) ? (f.hidden = !0, f) : null;
			}
			if (h) {
				return h.process && 0 === h.direction.y && (c = this.getMapValue(a, b), a = this.getSecret(a, b, h), !c && !a) ? (h.hidden = !0, h) : null;
			}
			if (g) {
				return g.process && 0 === g.direction.y && (c = this.getMapValue(a,
	...
	removeAI: function(a) {
		this.ai.splice(this.ai.indexOf(a),
			1);
		a = this.aiHistory.add.indexOf(a);
		-1 < a && this.aiHistory.add.splice(a, 1);
	},
	...
	removeSprite: function(a) {
		...
		b = this.spriteHistory.add.indexOf(a);
		-1 < b ? this.spriteHistory.add.splice(b, 1) : this.spriteHistory.remove.push(a);
	}
};
player = {
	Player: function(a) {
...
player.Face.prototype = {
	...
	process: function(a) {
		if (!this.smile && !this.zombie && (0 < a.health ?
											(a = min(6, max(0, 6 - floor(a.health / (a.max.health / 7)))), this.level !== a && (this.level = a, this.render())) : (this.faceTimer && (clearTimeout(this.faceTimer), delete this.faceTimer), this.level = 7, this.direction = 0, this.render()), !this.faceTimer && 7 > this.level)) {
			this.faceTimer = setTimeout(utils.bind(this, function() {
...
player.Player.prototype = {
	...
	setProperty: function(a, b) {
		if (!a || !b || void 0 === this[a] || void 0 === this.min[a] || void 0 === this.max[a] || 0 === b) {
			return !1;
		}
		var c = !1;
	...
	sprite: function() {
		if (!game.editor) {
			for (var a = this.map.hitSprites(floor(this.x), floor(this.y)), b = a.length; 0 < b; b--) {
				a[b - 1].listeners.hit(this);
			}
		}
	},
	door: function() {
		...
		if (d && (!d.key || this.keys.has(d.key))) {
			d[d.action](), a = !1;
			...
			if (!this.map.getMapValue(e, f) && (d.direction = {
				...
				if (0 === d.direction.x || 0 === d.direction.y) {
					d.push(), this.ratio.secret++, a = !1;
				}
			}
		}
...
ai = {
			...
			animations: {
				...
				dead: new animation.Animation({
					...
					callback: utils.bind(this, function() {
						...
						this.hitpoints = 0;
						if (game.auto) {
							this.endDeathCam && (document.getElementById('deathcam').style.display = 'none', this.action = this.dead);
						} else {
							var a = this;
							ai.process = [a];
							animation.process = [];
					...
					callback: utils.bind(this, function() {
						...
						if (game.auto) {
							...
							game.auto = function() {
								game.engine.maskColor = '#004040';
								if (game.restart) {
									game.restartClear && (game.restartClear = game.engine.fizzleClear(), game.restartClear || (document.getElementById('deathcam').style.display = null, a.animate('dying'), a.action = null, game.auto = function() {
										'dead' === a.animations.current ? (a.endDeathCam = !0, a.animate('dead')) : a.animate('dying');
									}));
								} else if (game.restart = !game.engine.fizzleFade(), game.restart) {
									document.getElementById('letsseethatagain').style.display = 'block';
	...
	HiMissile: function(a) {
		utils.extend(a, {
			...
			aiType: 'fake',
			animations: {
				run: new animation.Animation({slide: !0}),
		...
		utils.extend(a,
			{
				...
				animations: {
					...
					ready: new animation.Animation({slide: !0}),
					fire: new animation.Animation({
...
utils.overwrite(ai.Entity.prototype = Object.create(sprites.Sprite.prototype), {
	...
	calculateSlide: function(a, b) {
		if (this.animations.current && !this.animations[this.animations.current].slide) {
			this.slide = 0;
		} else {
	...
	isVisible: function(a, b, c) {
		for (var d = floor(a), e = floor(b), f = floor((a - d) * this.detailLevel), h = floor((b - e) * this.detailLevel), b = this.baseX, a = this.baseY, g = floor((this.x + 0.5 - this.baseX) * this.detailLevel), j = floor((this.y + 0.5 - this.baseY) * this.detailLevel), b = b * this.detailLevel + g, a = a * this.detailLevel + j, d = d * this.detailLevel + f, e = e * this.detailLevel + h, f = abs(d - b), h = abs(e - a), j = b < d ? 1 : -1, g = a < e ? 1 : -1, i = f - h; ;) {
			...
			if (c.getMapValue(m, l) || (m = c.getDoor(m, l)) && m.isClosed()) {
				return !1;
			}
			m = 2 * i;
			m > -h && (i -= h, b += j);
	...
	getDirectionTo: function(a, b, c) {
		...
		for (var p = [
				[
					c.getHitValue(d - 1, e - 1, this) || d - 1 === a && e - 1 === b || 0 > [1, 2, 3, 4, 5].indexOf(this.angle), c.getHitValue(d - 1, e, this) || d - 1 === a && e === b || 0 >
				[2, 3, 4, 5, 6].indexOf(this.angle), c.getHitValue(d - 1, e + 1, this) || d - 1 === a && e + 1 === b || 0 > [3, 4, 5, 6, 7].indexOf(this.angle)
				], [c.getHitValue(d, e - 1, this) || d === a && e - 1 === b || 0 > [0, 1, 2, 3, 4].indexOf(this.angle), !1, c.getHitValue(d, e + 1, this) || d === a && e + 1 === b || 0 > [0, 4, 5, 6, 7].indexOf(this.angle)], [c.getHitValue(d + 1, e - 1, this) || d + 1 === a && e - 1 === b || 0 > [0, 1, 2, 3, 7].indexOf(this.angle), c.getHitValue(d + 1, e, this) || d + 1 === a && e === b || 0 > [0, 1, 2, 6, 7].indexOf(this.angle), c.getHitValue(d + 1, e + 1, this) || d + 1 === a && e + 1 === b || 0 > [0, 1, 5, 6, 7].indexOf(this.angle)]
			],
		...
		var r = 0,
			s = function() {
				...
				if (q[o] || this.prevX && this.prevY && d + n[o].x === this.prevX && e + n[o].y === this.prevY) {
					return o = (8 + (o + (f > h ? g : j))) % 8, s();
				}
				if (!p[1][n[o].y + 1] && !p[n[o].x + 1][1]) {
					return n[o];
				}
				o = (8 + (o + (f > h ? g : j))) % 8;
				return s();
		...
		switch (e) {
			case 0:
				if ('dog' === this.type || 'fake' === this.type) {
					if (a = d.getDoor(this.baseX + 1, this.baseY), d.getHitValue(this.baseX + 1, this.baseY, this) || a && !a.isOpen() || this.baseX + 1 === b && this.baseY === c) {
						return !1;
					}
			...
			case 1:
				...
				if (d.getHitValue(this.baseX + 1, this.baseY - 1, this) || a && !a.isOpen() || this.baseX + 1 === b && this.baseY - 1 === c) {
					return !1;
				}
				a = d.getDoor(this.baseX + 1, this.baseY);
				if (d.getHitValue(this.baseX + 1, this.baseY, this) || a && !a.isOpen() || this.baseX + 1 === b && this.baseY === c) {
					return !1;
				}
				a = d.getDoor(this.baseX, this.baseY - 1);
				if (d.getHitValue(this.baseX, this.baseY - 1, this) || a && !a.isOpen() || this.baseX === b && this.baseY - 1 === c) {
					return !1;
				}
				break;
			case 2:
				if ('dog' === this.type || 'fake' ==
					this.type) {
					if (a = d.getDoor(this.baseX, this.baseY - 1), d.getHitValue(this.baseX, this.baseY - 1, this) || a && !a.isOpen() || this.baseX === b && this.baseY - 1 === c) {
						return !1;
					}
				} else if (d.getHitValue(this.baseX, this.baseY - 1, this) || this.baseX === b && this.baseY - 1 === c) {
					return !1;
				}
				break;
			case 3:
			...
			case 4:
				...
				} else if (d.getHitValue(this.baseX - 1, this.baseY, this) || this.baseX - 1 === b && this.baseY === c) {
					return !1;
				}
				break;
			case 5:
			...
			case 6:
				if ('dog' === this.type || 'fake' === this.type) {
					if (a = d.getDoor(this.baseX, this.baseY + 1), d.getHitValue(this.baseX,
						this.baseY + 1, this) || a && !a.isOpen() || this.baseX === b && this.baseY + 1 === c) {
						return !1;
					}
				} else if (d.getHitValue(this.baseX, this.baseY + 1, this) || this.baseX === b && this.baseY + 1 === c) {
					return !1;
	...
	selectDodgeDirection: function(a, b, c) {
		if (0 !== this.detailX || 0 !== this.detailY) {
	...
	selectChaseDirection: function(a, b, c) {
		...
		if (i[1] !== h && (g = {
			...
			x: i[2].x,
			y: i[2].y
		}, this.tryWalk(g, a, b, c))) {
			return g;
		}
		if (d.x !== h.x && d.y !== h.y && this.tryWalk(d, a, b, c)) {
			return d;
		}
		d = [
			{
		...
		if (!this.reset) {
			...
			if ('dog' !== this.type && 'fake' !== this.type) {
				if (this.action === this.attack) {
					if ('walk' === this.animations.current || 'run' === this.animations.current ||
						...
						} else if (f && !f.isOpen() && 'open' === f.action) {
							f[f.action]();
						}
					}
			...
			if (d) {
				if ('walk' === this.animations.current || 'run' === this.animations.current || 'ready' === this.animations.current) {
					this.x += this.direction.x * (this.speed / this.detailLevel) * game.timeFactor, this.y += this.direction.y * (this.speed / this.detailLevel) * game.timeFactor, this.detailX += abs(floor(this.direction.x *
						this.speed * game.timeFactor)), this.detailY += abs(floor(this.direction.y * this.speed * game.timeFactor));
				}
			} else {
				this.direction = this.selectChaseDirection(a.x, a.y, a.map);
			}
		}
	},
	...
	damage: function(a) {
		if (this.hitpoints && 'dead' !== this.animations.current &&
			...
			var b = 0;
			if (0 === a.getActiveWeapon().id) {
				b = utils.random(255) >> 4;
			} else {
...
utils.overwrite(ai.Hans.prototype = Object.create(ai.Entity.prototype), {
	attack: function(a) {
		if (0 > this.timer || 5 < this.timer || this.action === this.attack) {
			...
			if ('dying' === this.animations.current || 'dead' === this.animations.current) {
	...
	fire: function(a) {
		if ('fire' === this.animations.current && this.isVisible(a.x, a.y, a.map)) {
			...
			this.action = this.attack, this.animate(this.animations.current);
		}
	},
	dead: function(a) {
		var b = this.baseX,
	...
	attack: function(a) {
		if (0 > this.timer || 5 < this.timer || this.action === this.attack) {
			...
			if ('dying' === this.animations.current || 'dead' === this.animations.current) {
				...
				if (this.reset || 0 === this.direction.x && 0 === this.direction.y) {
					this.direction = this.selectDodgeDirection(a.x, a.y, a.map), this.calculateAngle();
				}
				this.timer > ai.tick && ('walk' === this.animations.current || 'run' === this.animations.current || 'ready' === this.animations.current) && this.moveForward(a, 'run');
	...
	attack: function(a) {
		if (0 > this.timer || 5 < this.timer || this.action === this.attack) {
			...
			if ('dying' === this.animations.current || 'dead' === this.animations.current) {
				...
				if (this.reset || 0 === this.direction.x && 0 === this.direction.y) {
					this.direction = this.selectChaseDirection(a.x, a.y, a.map), this.calculateAngle();
				}
	...
	attack: function(a) {
		if (0 > this.timer || 5 < this.timer || this.action === this.attack) {
			...
			if ('dying' === this.animations.current || 'dead' === this.animations.current) {
				...
				('hit' === this.animations.current || 'ready' === this.animations.current || 'fire' === this.animations.current) && !b.process &&
				this.animate('run');
				if (d && (c <= sqrt2 && (a.setProperty('health', -utils.random(255) >> 8), 0 >= a.health && (a.deathCam = this), wolf3d.utils.flashHit()), this.action !== this.attack && this.action !== this.fire && this.soundOnAttack)) {
					audio.queueSound(this.soundOnAttack, this.baseX, this.baseY), scripts.process.push({
						x: this.baseX,
						y: this.baseY,
						action: 'attack'
					});
	...
	attack: function(a) {
		if (0 > this.timer || 5 < this.timer || this.action === this.attack) {
			...
			if ('dying' === this.animations.current || 'dead' === this.animations.current) {
				...
				this.animate('run');
				var e = !1;
				if (d && ('hit' !== this.animations.current || 'hit' === this.animations.current && !b.process)) {
					b = abs(floor(a.x) - this.baseX), d = abs(floor(a.y) - this.baseY), b = b > d ? b : d, c = !b || 1 === b && c <= sqrt2 ? 300 : floor(ai.tick << 4 / b), utils.random(255) < c && this.animate('fire'), e = !0;
				}
...
wolf3d = {
				...
				animation: {
					...
					callback: function(a) {
						...
						if (a.index === a.count - 1) {
							...
							// TODO: implement knifehitdoor sound
						}
					}
				}
			},
	...
	machineGun: function(a, b) {
		return {
			...
			listeners: {
				hit: function(a) {
					if (a.hasWeapon(wolf3d.utils.weapons.machineGun.id)) {
						a.setProperty('ammo', 6) && (audio.playSound('getmachine', null, !0), wolf3d.utils.flashAddon(), a.map.removeSprite(this));
					} else {
	...
	gatling: function(a, b) {
		return {
			...
			listeners: {
				hit: function(a) {
					if (a.hasWeapon(wolf3d.utils.weapons.gatling.id)) {
						a.setProperty('ammo', 6) && (audio.playSound('getgatling', null,
...
wolf3d.fonts.small = [
	null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, {
		...
		width: 8,
		data: [0, 62, 99, 123, 123, 123, 3, 30, 0, 0]
	}, {
		width: 7,
		...
		width: 8,
		data: [0, 99, 99, 99, 107, 127, 119, 99, 0, 0]
	}, {
		width: 8,
		...
		width: 7,
		data: [0, 56, 12, 12, 7, 12, 12, 56, 0, 0]
	}, {
		width: 3,
...
wolf3d.fonts.large = [
	null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, {
		...
		width: 12,
		data: [0, 1792, 1920, 960, 480, 240, 120, 60, 30, 15, 7, 0, 0]
	}, {
		width: 10,
		...
		width: 10,
		data: [0, 511, 511, 455, 224, 112, 56, 28, 28, 28, 28, 0, 0]
	}, {
		width: 10,
		...
		width: 10,
		data: [0, 254, 511, 455, 455, 455, 455, 455, 455, 511, 254, 56, 112]
	}, {
		width: 10,
		...
		width: 10,
		data: [0, 455, 455, 455, 455, 511, 254, 56, 56, 56, 56, 0, 0]
	}, {
		width: 10,
	...
	},
	{
		...
		width: 10,
		data: [0, 7, 7, 455, 487, 247, 127, 127, 247, 487, 455, 0, 0]
	}, {
		width: 4,
		data: [0, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 0, 0]
	}, {
		...
		width: 10,
		data: [0, 56, 56, 511, 511, 56, 56, 56, 56, 56, 56, 0, 0]
	}, {
		width: 10,
			...
			for (var f =
				...
				if (a[f]) {
					...
					for (var g = d.createImageData(c.width, c.height), j = 0; j < c.height; j++) {
						for (var i = 4 * j * c.width, m = 0; m < c.width; m++) {
							h.data[floor(j / 3)] & 1 << floor(m / 3) && (g.data[i + 4 * m] = b.r, g.data[i + 4 * m + 1] = b.g, g.data[i + 4 * m + 2] = b.b, g.data[i + 4 * m + 3] = 255);
						}
					}
	...
	text: function(a, b) {
		...
		for (var c = 0; c < b.length; c++) {
			var d = document.createElement('IMG'),
				e = b.charCodeAt(c);
			if (10 === e) {
				d = document.createElement('BR'), a.appendChild(d);
			} else if (32 === e) {
				d.width = 48, d.height = 48, d.src = 'images/hidden.png', a.appendChild(d);
			} else if (e = this.images[e]) {
				d.src = e.data, d.width = 1.5 * e.width, d.height = 1.5 * e.height, a.appendChild(d);
			}
		}
	}
};
font.Font.prototype = {
	text: function(a, b) {
		...
		for (var c = 0; c < b.length; c++) {
			...
			if (10 === e) {
				d = document.createElement('BR'), a.appendChild(d);
			} else if (e = this.images[e - 1]) {
				d.src = e.data, a.appendChild(d);
			}
		}
	}
};
raycast = {
	...
	Shader: function() {
		...
		for (var a = 0; 1024 > a; a += 4) {
			this.data.data[a] = 0, this.data.data[a + 1] = 0, this.data.data[a + 2] = 0, this.data.data[a + 3] = a;
		}
	...
	cast: function() {
		...
		for (var b = [], c = 0; c < this.width; c++) {
			...
			for (var t, f = !1; !f;) {
				...
				if (f = this.map.getSecret(m, l)) {
					k = !f.hidden && !f.shift ? f.state : 0, u = f.hidden, e.push(0 === t ? {
			...
			for (f = 0; f < d.length; f++) {
				...
				k.perspectiveDistance < p) {
					...
					if (0 === k.side && 0 < j || 1 === k.side && 0 > i) {
						n = resources.textureWidth - n - 1;
					}
		...
		for (f = 0; f < b.length; f++) {
			if (k = b[f], j = k.x - this.player.x + 0.5,
				...
				for (l = 0; l < m.length; l++) {
					l = m[l], l.stripeRight || (l.stripeRight = l.stripeLeft + 1, l.texRight = l.texLeft + 1), this.verticalContext.context.drawImage(k.texture, l.texLeft + (k.animations.current ? k.animations[k.animations.current].state + (k.animations[k.animations.current].slide ? k.getTextureSlide() :
		...
		if (-1 < window.location.href.search('showmap')) {
			for (f = 0; 64 > f; f++) {
				for (b = 0; 64 > b; b++) {
					this.verticalContext.context.fillStyle = this.map.getHitValue(b, f) ? '#f00' : '#00f', this.verticalContext.context.fillRect(5 + 2 * f, 5 + 2 * b, 2, 2);
				}
			}
			for (f = 0; f < this.map.ai.length; f++) {
				b = this.map.ai[f],
...
controller = {
	...
	keydown: function(a) {
		...
		for (var b in this.keys) {
			if (-1 < this.keys[b].keyCode.indexOf(a.keyCode)) {
				return void 0 === this.activeKey[b] && (this.activeKey[b] = !0, delete this.inactiveKey[b]), a.stopPropagation(), a.preventDefault(), !1;
			}
		}
	},
	keyup: function(a) {
		...
		for (var b in this.keys) {
			if (-1 < this.keys[b].keyCode.indexOf(a.keyCode)) {
				return delete this.activeKey[b], this.inactiveKey[b] = !0, a.stopPropagation(), a.preventDefault(), !1;
			}
		}
	},
		...
		for (var a in this.activeKey) {
			...
			if (this.activeKey[a] && this.activeListeners[a]) {
				if (b.exception) {
					...
					this.activeKey[a] = !this.activeListeners[a]() && !this.keys[a].single;
				}
			}
		}
		for (a in this.inactiveKey) {
			this.inactiveKey[a] &&
...
game = {
	...
	gameLoop: function() {
			...
			if (game.win) {
				...
				if (game.average) {
					if (game.average.totalTime += a, game.client.total.kill && (game.average.kill = floor((game.average.kill + floor(100 * (game.client.ratio.kill / game.client.total.kill))) / 2)), game.client.total.secret && (game.average.secret = floor((game.average.secret +
						floor(100 * (game.client.ratio.secret / game.client.total.secret))) / 2)), game.client.total.treasure) {
						game.average.treasure = floor((game.average.treasure + floor(100 * (game.client.ratio.treasure / game.client.total.treasure))) / 2);
					}
					...
					100), game.client.total.secret || (game.average.secret = 100), !game.client.total.treasure) {
					game.average.treasure = 100;
				}
				game.win = null;
				window.onfocus = null;
				game.loop = null;
															...
															var b = 0,
																c = setInterval(function() {
																	if (b === game.client.ratio.treasure) {
																		...
																		if (!game.client.extraLife) {
																			game.client.extraLife = 0;
																		}
																		...
																		if (game.average) {
																			...
																			if (game.client.total.kill) {
																				game.average.kill = floor((game.average.kill +
																					floor(game.client.ratio.kill / game.client.total.kill * 100)) / 2);
																			}
																			if (game.client.total.secret) {
																				game.average.secret = floor((game.average.secret + floor(game.client.ratio.secret / game.client.total.secret * 100)) / 2);
																			}
																			if (game.client.total.treasure) {
																				game.average.treasure = floor((game.average.treasure + floor(game.client.ratio.treasure / game.client.total.treasure * 100)) / 2);
																			}
																		} else {
																			game.average = {
																				totalTime: a,
		...
		0 === game.client.health && (game.death =
			!0);
		if (game.death) {
			if (game.client.deathCam) {
				if (document.getElementById('hand').style.display = 'none', game.client.deathCam.rotate) {
					if (('rotateRight' === game.client.deathCam.rotate && game.client.deathCam.center > game.engine.width / 2 || 'rotateLeft' === game.client.deathCam.rotate && game.client.deathCam.center <= game.engine.width / 2) && (game.client.deathCam.prevCenter !== game.client.deathCam.center || !game.client.deathCam.prevCenter)) {
						game.client.deathCam.prevCenter = game.client.deathCam.center, game.client[game.client.deathCam.rotate](),
							game.engine.render();
					} else {
						if (!game.restart && (game.restart = !game.engine.fizzleFade(), game.restart)) {
							if (audio.currentMusic && audio.stopMusic(), 0 < game.client.lives) {
								...
								game.client.weapons =
									[new player.Weapon(wolf3d.utils.weapons.knife), new player.Weapon(wolf3d.utils.weapons.pistol)];
								game.client.keys = new player.Keys;
								game.client.keys.render();
								'e7m21' === game.mapName && game.client.keys.add('gold');
								for (f = 0; f < game.client.weapons.length; f++) {
									h = game.client.weapons[f], h.animation && h.animation.callback && (h.animation.callback = utils.bind(game.client, h.animation.callback));
								}
								...
								game.client.deathCam = null, game.roster = !0;
							}
						}
					}
				} else {
					audio.playSound('playerdeath'), game.client.deathCam.center > game.engine.width / 2 ? game.client.deathCam.rotate = 'rotateRight' : game.client.deathCam.center <= game.engine.width / 2 && (game.client.deathCam.rotate = 'rotateLeft');
				}
			} else {
				game.restart && (game.roster ? audio.currentMusic || (window.onkeydown =
			...
			for (f = 0; f < secret.process.length; f++) {
				h = secret.process[f], h.process && h.process();
			}
			for (f = 0; f < animation.process.length; f++) {
				h = animation.process[f], h.process && h.process();
			}
			for (f = 0; f < ai.process.length; f++) {
				h = ai.process[f], h.process && h.process(game.client);
			}
			for (scripts.process = []; audio.process.length;) {
				h =
				...
				game.requestJavaScript('animation,sprites,doors,secret,scripts,maps,player,ai,raycast,controller'.split(','), function() {
					...
					maps.request(game.mapName, function() {
						...
						if (game.client) {
							...
							game.client.weapons = [
								new player.Weapon(wolf3d.utils.weapons.knife),
							...
							for (var a = 0; a < game.client.weapons.length; a++) {
								...
								if (b.animation && b.animation.callback) {
									b.animation.callback = utils.bind(game.client, b.animation.callback);
								}
							}
							game.client.activeWeapon = game.client.weapons[game.client.weapons.length - 1];
							game.client.activeWeapon.render();
						} else {
							game.client = new player.Player({
						...
						if (game.engine) {
							...
							if (localStorage.graphics) {
								wolf3d.graphics = JSON.parse(localStorage.graphics);
							}
							...
							game.ctrl = new controller.Controller({
								...
								activeListeners: {
									viewInc: function() {
										...
										if (a.style.zoom !== void 0) {
											a.style.zoom = parseFloat(localStorage.zoom);
										} else if (a.style.MozTransform !== void 0) {
											a.style.MozTransform = 'scale(' + localStorage.zoom + ')';
										}
									},
									viewDec: function() {
										var a = document.getElementById('game');
										if (localStorage.zoom) {
											if (parseFloat(localStorage.zoom) > 0.1) {
												localStorage.zoom = (round(localStorage.zoom * 100) - 1) / 100;
											}
										} else {
											localStorage.zoom = 0.99;
										}
										if (a.style.zoom !== void 0) {
											a.style.zoom = parseFloat(localStorage.zoom);
									...
									menu: function() {
										if (game.death || game.restart || game.roster) {
											return false;
										}
										game.pause = true;
									...
									l: function() {
										if (game.death || game.restart || game.roster || !game.m) {
											return false;
										}
										game.l = true;
									},
									i: function() {
										if (game.death || game.restart || game.roster || !game.m || !game.l) {
											return false;
										}
										game.i = true;
										game.client.setProperty('health', 100);
										...
										if (!game.client.hasWeapon(wolf3d.utils.weapons.machineGun.id)) {
											...
											if (a.animation && a.animation.callback) {
												a.animation.callback = utils.bind(game.client, a.animation.callback);
											}
		...
		if (document.getElementById(a)) {
			...
			c.onload = function() {
				if (200 === c.status) {
					...
					window.onkeydown = window.onclick = null, audio.stopMusic(), audio.playSound('playerdeath'), game.showMessage('Error loading page!\n' + a + '.html not found?\nPlease check your connection\nor try again later...');
				}
			};
			c.send();
		}
		...
		if (40 === a.keyCode || 38 === a.keyCode) {
			...
			switch (a.keyCode) {
				case 40:
					...
					for (a = !1; -1 < c[b.cursorIndex].className.search("disabled");) {
						a =
							!0, b.cursorIndex++, b.cursorIndex === d && (b.cursorIndex = 0);
					}
				...
				case 38:
					...
					for (a = !1; -1 < c[b.cursorIndex].className.search("disabled");) {
						a = !0, b.cursorIndex--, 0 > b.cursorIndex && (b.cursorIndex = d - 1);
					}
					audio.playSound(a ? 'movegun2' : 'movegun1');
			}
			e = c[b.cursorIndex];
			...
			13 === a.keyCode ? (window.onkeydown = window.onclick = null, audio.playSound('shoot'), game.difficulty = b.cursorIndex, document.body.parentNode.style.backgroundColor = null, document.body.style.backgroundColor = null, game.hideScreen('difficulty'), audio.currentMusic && audio.stopMusic(), setTimeout(function() {
	...
	difficultySelection: function() {
		game.showScreen('difficulty', null, function() {
			...
			for (var a = document.querySelectorAll('#difficulty .options .text'), b = 0; b < a.length; b++) {
				...
				c.onmouseup = function(a) {
					if ('difficulty' === game.activeScreen && (a || (a = window.event), 0 === a.button)) {
						window.onkeydown = window.onclick = null, audio.playSound('shoot'), a = document.getElementById('difficultycursor'), game.difficulty = a.cursorIndex, document.body.parentNode.style.backgroundColor = null, document.body.style.backgroundColor = null, game.hideScreen('difficulty'), audio.currentMusic && audio.stopMusic(), setTimeout(function() {
							game.newGame(game.mapName, game.difficulty, game.tick);
						}, 500);
					}
				};
			...
			window.onmouseup = function(a) {
				if ('difficulty' ==
					...
					window.onkeydown = window.onclick = null, audio.playSound('escpressed'), game.hideScreen('difficulty', game.episode);
				}
			};
			c = a[2];
			...
			for (b = 0; b < a.length; b++) {
				2 !== b && (c = a[b], c.className = c.className.replace(' selected', ''), game.largeText.text(c, game.difficultyMenu[b]));
			}
			setTimeout(function() {
	...
	episodeCtrl: function(a) {
		a ||
		(a = window.event);
		for (var b = !1, c = document.getElementById('episodecursor'), d = document.querySelectorAll('#episode .options .episode'), e = 0; e < d.length; e++) {
			game.episodeMenu[e] = d[e].getAttribute('episode');
		}
		...
		if (40 === a.keyCode || 38 === a.keyCode) {
			...
			switch (a.keyCode) {
				case 40:
					...
					for (h = !1; -1 < e[2 * c.cursorIndex].className.search("disabled");) {
						h = !0, c.cursorIndex++, c.cursorIndex === f && (c.cursorIndex = 0);
					}
				...
				case 38:
					...
					for (h = !1; -1 < e[2 * c.cursorIndex].className.search("disabled");) {
						h = !0, c.cursorIndex--, 0 > c.cursorIndex && (c.cursorIndex =
							f - 1);
					}
					audio.playSound(h ? 'movegun2' : 'movegun1');
					b = !0;
			...
			13 === a.keyCode ? (audio.playSound('shoot'), window.onkeydown = window.onclick = null, game.loop ? (game.showMessage(game.curgameStr), window.onkeydown =
				function(a) {
					if (!a) {
						a = window.event;
					}
	...
	episode: function() {
		game.showScreen('episode', null, function() {
			...
			a.cursorIndex = 0;
			a.style.top = '0px';
			for (var b = document.querySelectorAll('#episode .options .episode'), a = 0; a < b.length; a++) {
				game.episodeMenu[a] = b[a].getAttribute('episode');
			}
			...
			window.onmouseup = function(a) {
				if ('episode' === game.activeScreen && (a || (a = window.event), 0 !== a.button)) {
					window.onkeydown = window.onclick = null, audio.playSound('escpressed'), game.hideScreen('episode', game.loop ? game.gameMenu : game.menu);
				}
			};
			var b = document.querySelectorAll('#episode .options .episode .text'),
				c = b[0],
			...
			for (a = 1; a < b.length / 2; a++) {
				c = b[2 * a], d = b[2 * a + 1], c.className = c.className.replace(' selected', ''), d.className = d.className.replace(' selected', ''), game.largeText.text(c, 'Episode ' + (a + 1)), game.largeText.text(d, game.episodeMenu[a]);
			}
			setTimeout(function() {
					window.onkeydown = game.episodeCtrl;
				},
	...
	detail: function() {
		game.showScreen('detail', null, function() {
			...
			var b = document.getElementById('detailcursor');
			if (void 0 === b.cursorIndex || null === b.cursorIndex) {
				b.cursorIndex = a.width / 160 - 1;
			}
			b.style.top = 44 * b.cursorIndex + 'px';
			var c = document.querySelectorAll('#detail .options tr');
			window.onmouseup = function(a) {
				if ('detail' === game.activeScreen && (a || (a = window.event), 0 !== a.button)) {
					window.onkeydown =
			...
			for (var d = 0; d < c.length; d++) {
				...
				e.onmouseup = function(a) {
					if ('detail' === game.activeScreen && (a || (a = window.event), 0 === a.button)) {
						a = document.getElementById('detailcursor'), audio.playSound('shoot'),
							a = {
				...
				if (d === b.cursorIndex) {
					for (f = 0; f < e.length; f++) {
						0 > e[f].className.search('selected') &&
					...
					for (f = 0; f < e.length; f++) {
						e[f].className = e[f].className.replace(' selected', ''), 0 === f ? game.largeText.text(e[f], (160 * (d + 1)).toString()) : 1 === f ? game.largeText.text(e[f], 'x') : 2 === f && game.largeText.text(e[f], (120 * (d + 1)).toString());
					}
				}
			}
		...
		switch (a.keyCode) {
			...
			case 37:
				...
				if (-1 < a.className.search('sound')) {
					...
					0 < audio.musicVolume && (audio.playSound('movegun2'), a = document.querySelector('#sound .musicoption .thumb'), b = document.querySelector('#sound .musicoption .text.readthis'), c = round(100 * audio.musicVolume) - 10, audio.setMusicVolume(c / 100), a.style.marginLeft = floor(5.5 * c) + 'px', b.style.marginLeft = 150 + floor(5 * c) + 'px', game.largeReadthis.text(b,
						c + '%'));
				}
				break;
			case 39:
				a = document.getElementById('soundcursor');
				-1 < a.className.search('sound') ? 1 > audio.soundsVolume && (audio.playSound('movegun2'), a = document.querySelector('#sound .soundoption .thumb'), b = document.querySelector('#sound .soundoption .text.readthis'), c = round(100 * audio.soundsVolume) + 10, audio.setSoundsVolume(c / 100), a.style.marginLeft = floor(5.5 * c) + 'px', b.style.marginLeft = 150 + floor(5 * c) + 'px', game.largeReadthis.text(b, c + '%')) : 1 > audio.musicVolume && (audio.playSound('movegun2'), a = document.querySelector('#sound .musicoption .thumb'),
	...
	sound: function() {
		game.showScreen('sound', null, function() {
			document.querySelector('#sound .soundoption').onmousemove = function() {
				if ('sound' ==
					game.activeScreen) {
					var a = document.getElementById('soundcursor');
					-1 < a.className.search('sound') || (audio.playSound('movegun1'), a.className = a.className.replace(' music', ' sound'));
				}
			};
			document.querySelector('#sound .musicoption').onmousemove = function() {
				if ('sound' === game.activeScreen) {
					var a = document.getElementById('soundcursor');
					-1 < a.className.search('music') || (audio.playSound('movegun1'), a.className = a.className.replace(' sound', ' music'));
				}
			};
	...
	customize: function() {
		game.showScreen('customize', null, function() {
			...
			if (void 0 === a.cursorIndex || null === a.cursorIndex) {
				a.cursorIndex = 0;
			}
			...
			if (a.wait) {
				...
				window.onkeydown = function(d) {
					...
					if (game.keyNames[d.keyCode]) {
						...
						if (b[a.cursorIndex] === c[2]) {
							if (a.posIndex === 0) {
								game.ctrl ? game.ctrl.keys.run.keyCode = [d.keyCode] : controller.keys.run.keyCode = [d.keyCode];
							} else if (a.posIndex === 1) {
								game.ctrl ? game.ctrl.keys.door.keyCode = [d.keyCode] : controller.keys.door.keyCode = [d.keyCode];
							} else if (a.posIndex === 2) {
								game.ctrl ? game.ctrl.keys.fire.keyCode = [d.keyCode] : controller.keys.fire.keyCode = [d.keyCode];
							} else {
								if (a.posIndex === 3) {
									game.ctrl ? game.ctrl.keys.strafe.keyCode = [d.keyCode] : controller.keys.strafe.keyCode = [d.keyCode];
								}
							}
						} else if (b[a.cursorIndex] === c[3]) {
							if (a.posIndex === 0) {
								game.ctrl ? game.ctrl.keys.left.keyCode = [d.keyCode] : controller.keys.left.keyCode = [d.keyCode];
							} else if (a.posIndex === 1) {
								game.ctrl ? game.ctrl.keys.right.keyCode = [d.keyCode] : controller.keys.right.keyCode = [d.keyCode];
							} else if (a.posIndex ==
								2) {
								game.ctrl ? game.ctrl.keys.forward.keyCode = [d.keyCode] : controller.keys.forward.keyCode = [d.keyCode];
							} else if (a.posIndex === 3) {
								game.ctrl ? game.ctrl.keys.backward.keyCode = [d.keyCode] : controller.keys.backward.keyCode = [d.keyCode];
							}
						}
				...
				window.onkeydown !== game.customizeCtrl && setTimeout(function() {
					window.onmouseup = function(a) {
			...
			if (b < parseInt(e[6].score)) {
				...
				window.onkeydown = function(a) {
					...
					if (i.children.length &&
						13 === b) {
						window.onkeydown = null, audio.playSound('shoot'), n.style.display = 'none', e.push({
							name: s,
							level: o,
							score: r
						}), e.sort(function(a, b) {
						...
						if (8 === b) {
							return i.children.length && (i.removeChild(i.lastChild), n.style.marginLeft = i.offsetWidth + 'px', s = s.substring(0, s.length - 1)), a.stopPropagation(), a.preventDefault(), !1;
						}
						if (15 > i.children.length && (32 === b || 47 < b && 91 > b || 105 < b && 112 > b && 108 !=
							...
							if (47 < b && 58 > b) {
								...
								a.shiftKey || (b += 32), d = String.fromCharCode(b);
							} else {
								switch (b) {
									case 32:
										d = ' ';
	...
	newLoadGame: function(a) {
		game.newGame(a.mapName.slice(0, 3) + a.player.floor, a.difficulty, game.tick, function() {
			...
			for (b = 0; b < a.spriteHistory.add.length; b++) {
				game.client.map.addSprite(new sprites.Sprite(eval(a.spriteHistory.add[b])));
			}
			for (b = 0; b < a.spriteHistory.remove.length; b++) {
				for (c = 0; c < game.client.map.sprites.length; c++) {
					a.spriteHistory.remove[b] === game.client.map.sprites[c].eval && game.client.map.removeSprite(game.client.map.sprites[c]);
				}
			}
			for (b = 0; b < a.aiHistory.add.length; b++) {
				game.client.map.addAI(eval(a.aiHistory.add[b]));
			}
			...
			for (b = 0; b < game.client.map.secrets.length; b++) {
				if (e = game.client.map.secrets[b], -1 < a.secretsHistory.remove.indexOf(e.eval) && game.client.map.removeSecret(e), (c = a.secrets[e.eval]) && c.direction) {
					e.x = c.x, e.y = c.y, e.state = c.state, e.direction = {
						x: c.direction.x,
						y: c.direction.y
	...
	newSaveGame: function() {
		if (game.mapName === null || game.client === null) {
			return;
		}
		...
		for (var a = {
			...
			aiHistory: {add: []},
			secrets: {},
			secretsHistory: {remove: []},
			map: game.client.map.map,
			hit: game.client.map.hit
		}, b = 0; b < game.client.weapons.length; b++) {
			a.player.weapons.push(game.client.weapons[b].id);
		}
		...
		for (b = 0; b < game.client.map.spriteHistory.remove.length; b++) {
			c = game.client.map.spriteHistory.remove[b], a.spriteHistory.remove.push(c.eval);
		}
		for (b = 0; b < game.client.map.spriteHistory.add.length; b++) {
			c = game.client.map.spriteHistory.add[b], a.spriteHistory.add.push(c.eval);
		}
		for (b = 0; b < game.client.map.aiHistory.add.length; b++) {
			c = game.client.map.aiHistory.add[b], a.aiHistory.add.push(c.eval);
		}
		for (b = 0; b < game.client.map.ai.length; b++) {
			...
			a.ai[c.eval] =
				{
					...
					hit: c.hit,
					animations: {current: c.animations.current},
					action: c.action,
					process: !!c.process
				};
			for (var e in c.animations) {
				'object' === typeof c.animations[e] && (d = c.animations[e], a.ai[c.eval].animations[e] = {
					keyframe: d.keyframe,
					state: d.state,
					speed: d.speed,
					count: d.count,
			...
			for (var f in c) {
				'function' === typeof c[f] && a.ai[c.eval].action === c[f] && (a.ai[c.eval].action = f);
			}
		}
		for (b = 0; b < game.client.map.secrets.length; b++) {
			c = game.client.map.secrets[b], a.secrets[c.eval] = {
				x: c.x,
				y: c.y,
				state: c.state,
		...
		for (b = 0; b < game.client.map.secretsHistory.remove.length; b++) {
			a.secretsHistory.remove.push(game.client.map.secretsHistory.remove[b].eval);
		}
		return a;
	},
			...
			default:
				if (d && 15 > game.slots[b.cursorIndex].name.length && (c = a.keyCode, 32 === c || 47 < c && 91 > c || 105 < c && 112 > c && 108 !== c || 185 < c && 193 > c || 218 < c && 223 > c)) {
					...
					if (47 < c && 58 > c) {
						...
						a.shiftKey || (c += 32), d = String.fromCharCode(c);
					} else {
						switch (c) {
							case 32:
								d = ' ';
													...
													game.hideScreen('gamemenu', function() {
														...
														game.showScreen('game', null, function() {
															...
															setTimeout(function() {
																...
																for (game.client.deathCam = game.client.map.ai[utils.random(game.client.map.ai.length - 1)]; game.client.deathCam.center === void 0;) {
																	game.client.deathCam = game.client.map.ai[utils.random(game.client.map.ai.length - 1)];
																}
															}, 1E3);
														});
													});
													...
													game.showScreen('game', null, function() {
														...
														setTimeout(function() {
															...
															for (game.client.deathCam =
																	 game.client.map.ai[utils.random(game.client.map.ai.length - 1)]; game.client.deathCam.center === void 0;) {
																game.client.deathCam = game.client.map.ai[utils.random(game.client.map.ai.length - 1)];
															}
														}, 1E3);
													});
					...
					var d = document.querySelectorAll('#' + a + ' .page'),
						...
						f = function(a) {
							for (var b = 0; b < d.length; b++) {
								d[b].className = d[b].className.replace(' selected', '');
							}
	...
	init: function() {
		...
		game.debug = a.debug;
		a.loadgame ? game.newLoadGame(JSON.parse(localStorage.slots)[a.loadgame]) : a.map ? game.newGame(a.map || 'e1m1', parseInt(a.difficulty || '0'), game.tick) : (audio.playMusic('nazi-nor'), game.pc13());
