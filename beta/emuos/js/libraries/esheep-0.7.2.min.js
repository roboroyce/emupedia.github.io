...
var DEFAULT_XML = "js/libraries/esheep-animations-0.7.2.xml"; // default XML animation
  ...
  _createClass(eSheep, [{
    ...
    value: function _parseXML(text) {
      ...
      this.sprite.addEventListener("load", function () {
        ...
        attribute = "width:" + _this2.imageW + "px;" + "height:" + _this2.imageH + "px;" + "position:fixed;" + "top:" + _this2.imageY + "px;" + "left:" + _this2.imageX + "px;" + "transform:rotatey(0deg);" + "cursor:move;" + "z-index:20000;" + "overflow:hidden;";
    ...
    value: function _loadPetList(element) {
      ...
      fetch("js/config/esheep-pets-0.7.2.json", {
